...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('edc_action_item', '0024_auto_20190922_0439'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ae_classification_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=250, null=True, verbose_name='If Other, specify ...')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_informant_relationship', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If Other, specify ...')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_report', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_ae.DeathReport')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ae_classification_other', edc_model_fields.fields.other_charfield.OtherCharField(blank=True, editable=False, max_length=250, null=True, verbose_name='If Other, specify ...')),
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('ae_initial', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='meta_ae.AeInitial')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionItem')),
                ('cause_of_death', models.ForeignKey(help_text='Main cause of death in the opinion of the local study doctor and local PI', null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.CauseOfDeath', verbose_name='Main cause of death')),
                ('death_report', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='meta_ae.DeathReport')),
                ('parent_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('officials_notified', models.DateTimeField(blank=True, null=True, validators=[edc_model.validators.date.datetime_not_future], verbose_name='Date and time regulatory authorities notified (SUSARs)')),
                ('action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.ActionItem')),
                ('ae_initial', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='meta_ae.AeInitial')),
                ('parent_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('related_action_item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.ActionItem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_ae_dea_subject_507bd3_idx'),
        ),
        migrations.AddIndex(
            model_name='deathreport',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_ae_dea_subject_9f6a2c_idx'),
        ),
        migrations.AddIndex(
            model_name='aetmg',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_ae_aet_subject_625c40_idx'),
        ),
        migrations.AddIndex(
            model_name='aesusar',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_ae_aes_subject_3daa6f_idx'),
        ),
        migrations.AddIndex(
            model_name='aeinitial',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_ae_aei_subject_9fefa3_idx'),
        ),
        migrations.AddIndex(
            model_name='aefollowup',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='meta_ae_aef_subject_a574af_idx'),
        ),
    ]
