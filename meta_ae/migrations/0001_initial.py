    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sae_reason_old', models.CharField(choices=[('N/A', 'Not applicable'), ('dead', 'Death'), ('life_threatening', 'Life-threatening'), ('significant_disability', 'Significant disability'), ('in-patient_hospitalization', 'In-patient hospitalization or prolongation (17 or more days from study inclusion)'), ('medically_important_event', 'Medically important event (e.g. Severe thrombophlebitis, Bacteraemia, recurrence of symptoms not requiring admission, Hospital acquired pneumonia)')], default='QUESTION_RETIRED', help_text='If subject deceased, submit a Death Report', max_length=50, verbose_name='If "Yes", reason for SAE:')),
                ('ae_classification_old', models.CharField(default='QUESTION_RETIRED', max_length=150)),
